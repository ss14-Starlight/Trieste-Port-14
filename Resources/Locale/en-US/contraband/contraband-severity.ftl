...
contraband-examine-text-GrandTheft = [color=red]This item is a highly valuable target for criminals![/color]
contraband-examine-text-Syndicate = [color=crimson]This item is highly illegal Syndicate contraband![/color]
contraband-examine-text-Nanotrasen = [color=cyan]This item is highly illegal Nanotrasen contraband![/color]
